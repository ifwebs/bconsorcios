...
if (isset($_GET['acao']) && $_GET['acao'] == 'excluir'){
	...
	$deletar = mysql_query("DELETE FROM vantagens WHERE id_vantagem = '$id'");
	...
	echo '<meta HTTP-EQUIV="Refresh" CONTENT="0;URL=listar_vantagens.php">';
	exit();
			...
			<div class="row-fluid">
				<div class="box span12">
					<div class="box-header well">
						<h2><i class="icon-plane"></i> Listagem Vantagens</h2>
					</div>
						  ...
						  while($res = mysql_fetch_array($sql)){
							echo '<tr>';
								...
								echo '<td class="center">';
									echo '<a class="btn btn-info" href="editar_vantagens.php?id='.$res[0].'"><i class="icon-edit icon-white"></i></a>';
									echo '&nbsp;';
